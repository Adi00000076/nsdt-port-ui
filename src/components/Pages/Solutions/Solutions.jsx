...
const Solutions = () => {
  ...
  const cardData = [
...

    {
        ...
        title: 'Metro Rail',
        description: `
        Metro Rail, owns  complex assets with diverse configurations with a variety of asset types that are integrated and interdependent. Envision's offerings for Asset Management, Crew Management, Operations Management helps to improve efficiencies.`,
      },
...

      {
        ...
        title: 'Utilities',
        description: `
        Power generation, distribution, Water utilities immensely got benefitted with our Asset Management, HSE, Asset Performance Management, IIOT solutions for digital twin.`,
      },
...

      {
        ...
        title: 'Oil and Gas',
        description: `
        Our Asset Management, HSE, Crew Management, Asset Performance Management, Industry 4.0, IIOT solutions for digital twin. Our AI ML based predictive maintenance solution improve reliability`,
      },
  ];
  ...
  return (
    <>
     ...
     <strong  style={{ color: "blue" }}>NSDT</strong>    Best of the breed industry{" "}
        <strong  style={{ color: "blue" }}>SOLUTIONS</strong>
      </h1>
            ...
            <div className="col-sm-4" key={card.id}>
              <div className="card" style={{ width: "20rem" }}>
                ...
                <div className="card-body">
                  <h3 className="card-title text-center font-italic font-weight-bold">{card.title}</h3>
                  
                  <p className="card-text  text-center  text-justify-content-end">{card.description}</p>
