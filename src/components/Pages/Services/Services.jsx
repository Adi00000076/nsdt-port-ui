            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <ServiceBox
                  ...
                  description="CTOS streamlines terminal operations from vessel planning to gate operations. End-to-end solution for container terminals of any size. Plan your vessel operations, manage equipment utilization, and optimize the operations. 3D Planning, Automated Billing, Mobile solution, and a built-in EDI manager are key features."
                />
                <ServiceBox
                  imgSrc={s3}
                ...
                <ServiceBox
                  ...
                  description="Crew Management System is a software solution that can be used by train operators, train operator shunters, crew controllers, line supervisors, depot crew controllers, station managers, station controllers, depot managers, chief traffic controllers, operation schedulers, and train operators."
                />
                <ServiceBox
                  imgSrc={s5}
                  title="PCS MSW Customer Portals"
